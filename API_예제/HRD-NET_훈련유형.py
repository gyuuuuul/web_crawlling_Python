...
# 사용자 입력 받기
TrainingCase = input("훈련유형 (예: 'C0104': K-디지털트레이닝) : ").strip()
start_date = input("검색할 훈련 시작일을 입력하세요 (예: 20250101): ").strip()
end_date = input("검색할 훈련 종료일을 입력하세요 (예: 20251231): ").strip()
...
# ✅ API 키 - 국민내일배움카드
AUTH_KEYS_Card = "9f166e67-b76e-49f2-a34b-5e93e71e3cf6"

# ✅ 요청 URL - 국민내일배움카드
REQUEST_URLS_Card="https://www.work24.go.kr/cm/openApi/call/hr/callOpenApiSvcInfo310L01.do"

# ✅ 상세 정보 요청 URL -  국민내일배움카드
DETAIL_URLS_Card = "https://www.work24.go.kr/cm/openApi/call/hr/callOpenApiSvcInfo310L02.do"

results = fetch_training_data(AUTH_KEYS_Card, REQUEST_URLS_Card, "국민내일배움카드")
detailed_results = fetch_course_info(results, AUTH_KEYS_Card, "국민내일배움카드")
final_results.extend(detailed_results)

# ✅ 엑셀 저장
df = pd.DataFrame(final_results)
excel_filename = os.path.join(desktop_path, f"{TrainingCase + '_' + start_date + '-' + end_date }_훈련과정.xlsx")
