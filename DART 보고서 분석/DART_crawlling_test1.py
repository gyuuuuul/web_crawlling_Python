...
auth_key =  '2793c614ecaf8467a0f2e18e3268332f701237e0' # enter your auth_key registered at https://dart.fss.or.kr/dsap001/apikeyManagement.do
start_dt = '20200101' # start date(YYYYMMDD) 2004년 이전에는 sub menu의 양식이 다른 경우가 있음
...
print(crawldart("005930", "D001", "2. 세부변동내역"))
